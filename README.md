...
# Домашнее задание к занятию "`«Защита сети»`" - `Кузьминцев Илья`
...
nmap обнаружил порт ssh и доступность хоста. 
...
Cканирование nmap с опцией -sT (TCP connect-сканирование). 

Cканирование nmap с опцией -sS (TCP SYN-сканирование).

Cканирование nmap с опцией -sV (сканирование с определением версий).

Все три сканирования определялись как потенциально подозрительными.
